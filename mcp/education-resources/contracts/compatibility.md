...
- 当前 catalog 包含 12 个教育资源工具；Session Cookie、Token 和登录工具不属于该 catalog。
...
当前公共 catalog 的精确工具集合由 `tool-catalog.json` 定义。
...
学习资料归档在当前 major 内继续使用 `contract_version: "1.0.0"`，但 Archive 与 Library Search 的
