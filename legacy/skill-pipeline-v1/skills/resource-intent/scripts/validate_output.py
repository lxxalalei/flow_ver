#!/usr/bin/env python3
"""Validate intent-spec/v1, including legacy clarification artifacts.

Current resource-intent producers only persist ready documents. Flow completion
enforces that boundary; this validator keeps v1 parsing backward compatible.
"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 intent-spec/v1；当前新流程只持久化 ready 输出")
